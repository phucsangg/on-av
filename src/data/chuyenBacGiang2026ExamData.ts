...
<u>Statistics from the American labor market indicate a substantial decrease in the number of workers quitting their jobs compared to previous years, highlighting this evolving trend.</u> Data from 2024 shows that 39.6 million Americans resigned from their jobs, an 11% drop from 2023 and a significant 22% decrease compared to 2022. This sharp decline reflects a major shift in employee attitudes, with many individuals choosing to "hug" their current jobs rather than risk changing roles.
