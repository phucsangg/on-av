...
const PASSAGE_OCEAN_TIDES = `Every drop of water in the ocean, even in the deepest parts, responds to the forces that create the tides. No other force that affects the sea is so strong. <u>Compared with the tides, the waves created by the wind are surface movements felt no more than a hundred fathoms below the surface.</u> The currents also seldom involve more than the upper several hundred fathoms despite <mark>their</mark> impressive sweep.
...
What endures, then, beyond seasonal campaigns, is a structural arithmetic. <mark style="background: #ea580c; color: #fff; box-shadow: 0 0 10px rgba(234, 88, 12, 0.4);">[IV]</mark> <u>Without binding caps on production and credible emissions accounting, sustainability talk risks net-greenwashing: relative improvements advertised as planetary salvation.</u> The sector’s outsized water draw, chemical intensity, and fossil-fuel dependency cannot be reconciled with breakneck turnover unless growth becomes materially decoupled from throughput – a prospect that, so far, appears aspirational rather than achieved, and one that demands coordinated regulatory resolve, transparent metrics, and a fundamental reorientation of value away from volume-driven expansion toward genuine long-term ecological stability.
