...
export const HANOI_2026_QUESTIONS: Question[] = [
  ...
  { id: 'hn-q28', type: 'pronunciation', questionText: 'Question 28. Choose the word whose underlined part is pronounced differently:', options: [{ id: 'A', text: 'cl<u>i</u>mate', translation: 'phát âm /aɪ/' }, { id: 'B', text: 'd<u>i</u>gital', translation: 'phát âm /ɪ/ (khác)' }, { id: 'C', text: 'pr<u>i</u>mary', translation: 'phát âm /aɪ/' }, { id: 'D', text: 'dev<u>i</u>ce', translation: 'phát âm /aɪ/' }], correctAnswer: 'B', explanation: '• B. ĐÚNG: "digital" phát âm nguyên âm /ɪ/, các từ còn lại phát âm /aɪ/.', translation: 'Chọn từ có nguyên âm gạch chân phát âm khác.', topicTag: 'Phát âm (Pronunciation)' },
  { id: 'hn-q29', type: 'pronunciation', questionText: 'Question 29. Choose the word whose underlined part is pronounced differently:', options: [{ id: 'A', text: '<u>s</u>pecies', translation: 'phát âm /s/' }, { id: 'B', text: '<u>s</u>ustainable', translation: 'phát âm /s/' }, { id: 'C', text: '<u>s</u>tress', translation: 'phát âm /s/' }, { id: 'D', text: 'vi<u>si</u>on', translation: 'phát âm /ʒ/ (khác)' }], correctAnswer: 'D', explanation: '• D. ĐÚNG: "vision" phát âm âm /ʒ/, các từ còn lại phát âm /s/.', translation: 'Chọn từ có phụ âm phát âm khác.', topicTag: 'Phát âm (Pronunciation)' },
